...
responses = {
	...
	'(?:what(?:\'s| is) the (?:meaning|purpose|reason) (?:of|for) (?:life|living|being alive)|why (?:are|am|is) (?:we|i|(?:yo)?u|me) (?:alive|here))': '42',
	'i (?:like|enjoy) (.+)': '%s sounds interesting. Tell me more.',
